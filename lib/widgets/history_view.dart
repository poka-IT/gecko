...
class HistoryView extends StatelessWidget {
  const HistoryView({super.key, required this.result, required this.address, required this.previousAddress});
            ...
            children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      if (pastDelimiters.length == 1 ||
                          pastDelimiters.length >= 2 &&
                              !(pastDelimiters[pastDelimiters.length - 2] == answer['dateDelimiter']))
                        Padding(
              ...
              if (result.isLoading && duniterIndexer.pageInfo!['hasNextPage'])
                const Row(
                  ...
                  children: <Widget>[Loading(size: 30, stroke: 3)],
                ),
