...
class Txs {
  ...
  _i4.TechnicalCommittee setMembers({
    ...
    return _i4.TechnicalCommittee(_i9.SetMembers(
  ...
  _i4.TechnicalCommittee execute({
    ...
    return _i4.TechnicalCommittee(_i9.Execute(
      proposal: proposal,
  ...
  _i4.TechnicalCommittee propose({
    ...
    return _i4.TechnicalCommittee(_i9.Propose(
      threshold: threshold,
      proposal: proposal,
      lengthBound: lengthBound,
    ));
  ...
  _i4.TechnicalCommittee vote({
    ...
    return _i4.TechnicalCommittee(_i9.Vote(
      proposal: proposal,
      index: index,
      approve: approve,
    ));
  ...
  _i4.TechnicalCommittee disapproveProposal({required _i2.H256 proposalHash}) {
    return _i4.TechnicalCommittee(
        _i9.DisapproveProposal(proposalHash: proposalHash));
  }
  ...
  _i4.TechnicalCommittee close({
    ...
    return _i4.TechnicalCommittee(_i9.Close(
